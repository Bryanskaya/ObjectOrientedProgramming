...
QT_MOC_LITERAL(1, 11, 11), // "btn_pressed"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "size_t"
QT_MOC_LITERAL(4, 31, 9), // "floor_num"
QT_MOC_LITERAL(5, 41, 12), // "slot_pressed"
QT_MOC_LITERAL(6, 54, 13) // "slot_released"

    },
    "LiftButton\0btn_pressed\0\0size_t\0floor_num\0"
...
void LiftButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->btn_pressed((*reinterpret_cast< size_t(*)>(_a[1]))); break;
        case 1: _t->slot_pressed(); break;
        case 2: _t->slot_released(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LiftButton::*)(size_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LiftButton::btn_pressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LiftButton::btn_pressed(size_t _t1)
{
